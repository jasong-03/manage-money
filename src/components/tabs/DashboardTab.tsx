  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        <h2 className="text-2xl font-bold">{formatPeriodDisplay(currentMonth)}</h2>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <Card className="p-4 text-center">
          <Wallet className="w-5 h-5 mx-auto text-green-500 mb-2" />
        ...
        {/* Spending */}
        <Card className="p-4 text-center">
          <ShoppingBag className="w-5 h-5 mx-auto text-red-500 mb-2" />
        ...
        {/* Net Income */}
        <Card className="p-4 text-center">
          <PiggyBank className="w-5 h-5 mx-auto text-blue-500 mb-2" />
          <p className="text-xs text-muted-foreground">Savings</p>
          <p className={`text-lg font-bold ${currentStats.netIncome >= 0 ? 'text-blue-600' : 'text-red-600'}`}>
        ...
        {/* Subscriptions */}
        <Card className="p-4 text-center">
          <CreditCard className="w-5 h-5 mx-auto text-purple-500 mb-2" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        {chartData.some((d) => d.amount > 0) && (
          <Card className="p-4">
            <h3 className="font-medium mb-4">Income Trend (6 months)</h3>
            <div className="h-48">
        ...
        {companyBreakdown.length > 0 && (
          <Card className="p-4">
            <h3 className="font-medium mb-4">By Company</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        {upcomingPayments.length > 0 && (
          <Card className="p-4">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-medium">Sắp đến hạn (7 ngày)</h3>
            </div>
            <div className="space-y-3">
              {upcomingPayments.map((sub: Subscription) => (
                <div key={sub.id} className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <p className="font-medium text-sm">{formatAmount(sub.amount)}</p>
                    <p className="text-xs text-muted-foreground">Ngày {sub.billingDay}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        {spendingByCategory.length > 0 && (
          <Card className="p-4">
            <h3 className="font-medium mb-4">Chi tiêu theo danh mục</h3>
            <div className="space-y-3">
      ...
      {companies.length === 0 && (
        <Card className="p-8 text-center">
          ...
          <p className="text-sm text-muted-foreground">
            Go to Compensation tab to add companies and track income
          </p>
        </Card>
      )}
    </div>
